...
#define STRING_CONFIG_H_AUTHOR "(Craig Howald, pultruder)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "PET puller"
 ...
 */
//cmh  #define PREVENT_COLD_EXTRUSION
