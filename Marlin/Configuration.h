...
#define STRING_CONFIG_H_AUTHOR "(Craig Howald, 20220106 McP SKR V1.4 Bear TMC2209 BLTouch HT v21)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "^^( Printer 21"
...
#define TEMP_BED_WINDOW              6  // (°C) Temperature proximity for the "temperature reached" timer
#define TEMP_BED_HYSTERESIS          16  // (°C) Temperature proximity considered "close enough" to the target

#define TEMP_CHAMBER_RESIDENCY_TIME 10  // (seconds) Time to wait for chamber to "settle" in M191
#define TEMP_CHAMBER_WINDOW          3  // (°C) Temperature proximity for the "temperature reached" timer
#define TEMP_CHAMBER_HYSTERESIS      8  // (°C) Temperature proximity considered "close enough" to the target
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27.5, 4.7, -2.8 }
