...
#define STRING_CONFIG_H_AUTHOR "(Craig Howald, 20210801 McP SKR V1.4 Bear TMC2209 BLTouch HT v21)" // Who made the changes.
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 27.5, 4.7, 0 }
