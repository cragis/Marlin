...
#define STRING_CONFIG_H_AUTHOR "(Craig Howald, 20190213)" // Who made the changes.
...
#define PID_MAX 155 // Limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKi 6
  #define DEFAULT_bedKd 640
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 200, 200, 800, 287 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2[, E3[, E4]]]]
 */
#define DEFAULT_MAX_FEEDRATE          { 200, 200, 20, 90 }
